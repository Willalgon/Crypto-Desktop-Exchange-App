class ActivoVO:
    def __init__(self, id_activo=None, nombre=None, simbolo=None,
        ...
        self.__historial_precios    = []  # lista de (precio: float, fecha_hora: str)

    # ── Getters ───────────────────────────────────────────────────────────────

    @property
    def id_activo(self):            return self.__id_activo
    @property
    ...
    @property
    def descripcion_especial(self): return self.__descripcion_especial
    @property
    def es_cripto(self):            return self.__es_cripto
    @property
    def historial_precios(self):    return self.__historial_precios  # [(precio, fecha_hora), ...]
